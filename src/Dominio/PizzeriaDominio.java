...
public class PizzeriaDominio {
    ...
    private PizzeriaDominio(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public Builder() {
            ...
            ubicacion = new UbicacionDominio.Builder().build();
        }
        ...
        public Builder ubicacion(UbicacionDominio ubicacion) {
            this.ubicacion = UtilObjeto
                    .obtenerValorDefectoSiValorOriginalEsNulo(
                            ubicacion,
                            new UbicacionDominio.Builder().build()
                    );
            return this;
        }

        public PizzeriaDominio build() {
            return new PizzeriaDominio(this);
        }
    }
}